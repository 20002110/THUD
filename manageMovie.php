...
<div class="container py-5">
    <a href="addNew.php" class="text-light"><button class="btn btn-primary my-5">Add product</button></a>
                    ...
                    foreach ($films as $film) {
                        $category = $db->find_data('TypeMovie', 'typeID', $film['typeID']);
                            ...
                            echo '<tr>
                                    ...
                                    <td>'.$language.'</td>
                                    <td>'.$premiere.'</td>
                                    <td class="describes-column">'.$describes.'</td>
                                    <td>'.$cost.'</td>
                                    <td><img src="'.$image_folder.'" height="200" width="100" class="border border-1"/></td>
                                    <td>
